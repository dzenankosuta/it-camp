...
function getRating(watchList) {
    ...
    let averageRating;
    const nolanMovies = watchList.filter((value) => value.Director === "Christopher Nolan")

    const ratings = nolanMovies.map((value) => +value.imdbRating)

    const len = ratings.length;
    averageRating = ratings.reduce((total, value) => total + value) / len
